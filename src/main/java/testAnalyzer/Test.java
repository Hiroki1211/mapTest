...
public class Test {
	...
	private ArrayList<InstanceMethodGroup> instanceMethodGroupLists = new ArrayList<InstanceMethodGroup>();
	
	public ArrayList<InstanceMethodGroup> getInstanceMethodGroupLists(){
		return instanceMethodGroupLists;
	}
	
	public void addInstanceMethodGroupLists(InstanceMethodGroup input) {
		instanceMethodGroupLists.add(input);
	}
